...
export const Sidebar = () => {
  return (
    <nav className='w-[330px] h-screen fixed flex items-start justify-between flex-col border-r border-r-gray-300'>
        ...
        <div className='w-full h-auto flex flex-col items-center justify-center gap-1 p-5'>
            <SideBarCard title={"Home"}/>
            <SideBarCard title={"Search"}/>
            <SideBarCard title={"Explore"}/>
            <SideBarCard title={"Reels"}/>
            <SideBarCard title={"Messages"}/>
            <SideBarCard title={"Notifications"}/>
            <SideBarCard title={"Create"}/>      
            <SideBarCard title={"Dashboard"}/>      
            <SideBarCard title={"Profile"}/>      
        </div>
        </div>
        <div className='w-full h-auto flex flex-col items-center justify-center gap-1 p-5'>
            <SideBarCard title={"AI Studio"}/>
            <SideBarCard title={"Threads"}/>
            <SideBarCard title={"More"}/>   
        </div>
    </nav>
  )
}
